# IAM Module - Following CIS v4 controls and least privilege principle
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = "arn:aws:ssm:*:${var.account_id}:parameter/${var.project_name}/${var.environment}/*"
      }
    ]
  })
}
...
resource "aws_iam_role_policy_attachment" "ecs_autoscaling_policy" {
  ...
  policy_arn = "arn:aws:iam::aws:policy/application-autoscaling/ECSServicePolicy"
}

# KMS Key for Secrets Manager (CIS 3.7)
...
# KMS Key for CloudWatch Logs (CIS 3.7)
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Condition = {
          ArnEquals = {
            "kms:EncryptionContext:aws:logs:arn" = "arn:aws:logs:*:${var.account_id}:log-group:/ecs/${var.project_name}-${var.environment}*"
          }
        }
      }
    ]
